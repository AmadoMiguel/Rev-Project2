...
export function IncomesTable(props: any) {
  ...
  // Define state and its update method to track changes of the editable income row
  ...
  function handleEditButton(income: Income) {
  ...
  // Function that listens for changes on any of the incomes
  const handleEditedIncomeChange = (event: any) => {
    setState({
      ...state,
    ...
    <div>
      <Paper className={classes.root}>
                  ...
                  (editableRow && editableRowKey === row.id) ?
                    ...
                    <Fragment>
                      <TableCell>
                        ...
                        {/* Assign the onClick function to notify the parent which income
                        will be deleted */}
                        <Button onClick={() => {
        ...
        {/* Display the delete confirm delete dialog when the user clicks on the 
            delete icon. It shows the information of the income before deleting
            it. User can select between cancel or delete. */}
        {
          ...
          <Paper style={{ textAlign: "center" }}>
            <Dialog open={confirmDialog}>
              <DialogContent>
                You are about to delete the following income:
                  <br /> <br />
